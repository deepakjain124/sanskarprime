...
/*-------------------------------------------------------------------------------
		  Banquet Hall Carousel
		-------------------------------------------------------------------------------*/



		$('.banquet-carousel').owlCarousel({
			dots: true,
			margin: 30,
			smartSpeed: 1000,
			autoplay:true,
	...
	if ($('.pagepiling').length > 0) {
		...
		$('.pagepiling').pagepiling({
			...
			afterLoad: function (anchorLink, index) {
				if (index == 2 || index == 3 || index == 4 || index == 5 || index == 6 || index == 7 || index == 8 || index == 10 || index == 12) {   /* 2, 4, 6, - sections with white bacgkgrounds */
