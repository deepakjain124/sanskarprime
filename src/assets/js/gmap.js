var mapLocation = new google.maps.LatLng(26.8907994, 75.742017); //change coordinates here
var marker;
var map;
function initialize() {
    var mapOptions = {
    ...
    + '   </span>'
    + '</div>' 
    + '<p class="gmap-open"><a href="https://www.google.com/maps/@26.8907994,75.742017,21z?hl=ru-RU" target="_blank">Open on Google Maps</a></p></div>';
